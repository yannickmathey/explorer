function styleCaractere(classe, nom, pack, italique) {
    ...
    window.tableau = {  
        ...
        C1G1: new styleCaractere("C1G1", "Panorama ExtraCondensed-Thin", "Panorama ExtraCondensed"),
        ...
        C1G8: new styleCaractere("C1G8", "Panorama ExtraCondensed-Ultra", "Panorama ExtraCondensed"),

        C2G1: new styleCaractere("C2G1", "Panorama SemiCondensed-Thin", "Panorama SemiCondensed"),
        ...
        C2G8: new styleCaractere("C2G8", "Panorama SemiCondensed-Ultra", "Panorama SemiCondensed", "Panorama SemiCondensed-UltraItalic"),

        C3G1: new styleCaractere("C3G1", "Panorama Condensed-Thin", "Panorama Condensed"),
        ...
        C3G8: new styleCaractere("C3G8", "Panorama Condensed-Ultra", "Panorama Condensed"),
        ...
        C5G1: new styleCaractere("C5G1", "Panorama Wide-Thin", "Panorama Wide"),
        ...
        C5G8: new styleCaractere("C5G8", "Panorama Wide-Ultra", "Panorama Wide"),

        C6G1: new styleCaractere("C6G1", "Panorama ExtraExtended-Thin", "Panorama ExtraExtended"),
        ...
        C6G8: new styleCaractere("C6G8", "Panorama ExtraExtended-Ultra", "Panorama ExtraExtended"),

        // italic

        C1G1I: new styleCaractere("C1G1I", "Panorama ExtraCondensed-Thin Italic", "Panorama ExtraCondensed"),
        ...
        C1G8I: new styleCaractere("C1G8I", "Panorama ExtraCondensed-Ultra Italic", "Panorama ExtraCondensed"),

        C2G1I: new styleCaractere("C2G1I", "Panorama SemiCondensed-Thin Italic", "Panorama SemiCondensed"),
        ...
        C2G8I: new styleCaractere("C2G8I", "Panorama SemiCondensed-Ultra Italic", "Panorama SemiCondensed"),

        C3G1I: new styleCaractere("C3G1I", "Panorama Condensed-Thin Italic", "Panorama Condensed"),
        ...
        C3G8I: new styleCaractere("C3G8I", "Panorama Condensed-Ultra Italic", "Panorama Condensed"),
        ...
        C5G1I: new styleCaractere("C5G1I", "Panorama Wide-Thin Italic", "Panorama Wide"),
        ...
        C5G8I: new styleCaractere("C5G8I", "Panorama Wide-Ultra Italic", "Panorama Wide"),

        C6G1I: new styleCaractere("C6G1I", "Panorama ExtraExtended-Thin Italic", "Panorama ExtraExtended"),
        ...
        C6G8I: new styleCaractere("C6G8I", "Panorama ExtraExtended-Ultra Italic", "Panorama ExtraExtended")
