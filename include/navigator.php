<div id="conteneurNavigator" class="BGblanc">
    ...
    <div id="repere"><p> <span class="C3G3" style="color:#333;">Panorama Regular <b class="glyphicon glyphicon-triangle rouge"></b></span></p></div>
        ...
        <ul id="circle_0" class="circleMenu recepteurGlyphe clearfix" name="width">
            ...
            <li name="C6" class="C6G4"><span class="conteneur rouge">A</span></li>
        ...
        <span class="legende legende_0"><div id="legende_0"><span class="glyphicon glyphicon-triangle-left rouge"></span> WIDTH</div></span>
        </ul>
        ...
        <ul id="circle_1" class="circleMenu recepteurGlyphe" name="thickness">
            ...
            <li name="G6" class="C4G6"><span class="conteneur bleu">A</span></li>
            <li name="G7" class="C4G7"><span class="conteneur bleu">A</span></li>
            <li name="G8" class="C4G8"><span class="conteneur bleu">A</span></li>
        ...
        <span class="legende legende_1"><div id="legende_1"><span class="glyphicon glyphicon-triangle-left bleu"></span> WEIGHT</div></span>
        </ul>
